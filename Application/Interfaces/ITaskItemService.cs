...
namespace Task_Management_API.Application.Interfaces
{
    public interface ITaskItemService
    {
        ...
        public Task<IPagedList<TaskItemDTO>> GetAllTaskItems(int pageNumber, int pageSize);
        ...
        public Task<TaskItemDTO> CreateTaskItem(CreateTaskItemDTO taskItemDTO);
        ...
        public Task<TaskItemDTO> UpdateTaskItem(Guid id, UpdateTaskItemDTO taskItemDTO);
